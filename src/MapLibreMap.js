...
export default class MapLibreMap extends React.Component {
  ...
  render() {
        ...
        >
          ...
          <Toast.Body>
            <span>
              ...
              <strong>15-Kilometer-Radius-Regel</strong> unterschiedlich um.
              Bitte informieren Sie sich bei der für Ihren Wohnort zuständigen
              Behörde.{" "}
            </span>
            <hr />
            <span>
    ...
    const WGInfo = () => (
      ...
      >
        <Toast
          onClose={() => this.setState({ showWGInfo: false })}
          show={this.state.showWGInfo}
        >
      ...
      <div>
        ...
        <div className="overlay">
          <Nav as="ul" className="glass">
            ...
            <Nav.Item className="navbtn" as="li">
              <Button variant="light" onClick={this.print}>
                <BiPrinter></BiPrinter>
              </Button>
            </Nav.Item>
            <Nav.Item className="navbtn" as="li">
              <Button variant="light" onClick={this.toggleWGInfo}>
                <WGLogo width="16px" />
              </Button>
            </Nav.Item>
            <Nav.Item className="navbtn" as="li">
              <Button variant="light" onClick={this.toggleInfo}>
                {" "}
                <BsInfoCircle />
              </Button>
            </Nav.Item>
