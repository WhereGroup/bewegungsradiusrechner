...
export default class MapLibreMap extends React.Component {
    ...
    print = () => {
        ...
        renderMap.once('idle', function () {
            ...
            pdf.setFillColor('white')
            const infoBoxSize = (textChunks.length * 3.25) + marginTop + marginBottom + 7
            pdf.rect(2.5, 2.5, 66.5, infoBoxSize, "F")
            pdf.setFontSize(10);// optional
            pdf.text("Bewegungsradiusrechner (15km) für:", 5, 6)
            pdf.rect(6, 7, 60,textChunks.length*3.25+2.5 )
            pdf.setFontSize(10);// optional
